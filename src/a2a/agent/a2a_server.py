...
class A2AServer:
    ...
    def _get_agent_card(self) -> AgentCard:
        """Return the Agent Card for the Zava Product Helper."""
        ...
        skill_product_helper = AgentSkill(
            ...
            description=(
                "Handles customer inquiries about Zava products, including features, "
                "pricing, and ranking products based on customer needs."
            ),
        ...
        return AgentCard(
            name="Zava Product Helper",
            description="Zava Product Helper providing comprehensive product information and recommendations.",
